...
export const pageContent = {
  metadata: {
    ...
    keywords: "ייעוץ משכנתאות, יועץ משכנתאות מומלץ, פגישת ייעוץ משכנתא, מיחזור משכנתא, השוואת יועצי משכנתאות, יועץ משכנתאות פרטי, עלות ייעוץ משכנתא, אלירן זיתונה, אלירן זיתונה יועץ משכנתאות",
    og: {
      title: "בשביל המשכנתא | ייעוץ משכנתאות מקצועי - משכנתא חדשה, מחזור, משכנתא הפוכה",
  ...
  hero: {
    ...
    subheadline: "אני אלירן זיתונה יועץ משכנתאות והבעלים של \"בשביל המשכנתא\"\n\nאנחנו חוסכים לך עשרות אלפי שקלים במשכנתא - רק עם ליווי מקצועי ממומחה תקבל מסלול מותאם אישית, עם הגנה פיננסית, שמירה על הבית ועל איכות החיים ובאמת תוכל לישון בשקט!",
    buttons: {
      new: "משכנתא חדשה",
